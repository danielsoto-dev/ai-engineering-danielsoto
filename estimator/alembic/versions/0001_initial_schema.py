"""Initial schema: pgvector extension + documents/chunks tables.

Revision ID: 0001
Revises:
Create Date: 2026-07-13

No vector index (HNSW/IVFFlat) yet — deliberate, see README. Sequential scan
is the intended baseline for this exercise.
"""
